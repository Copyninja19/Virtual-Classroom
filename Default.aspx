...
<body>
    ...
    <div id="top">
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/vc.jpg" />
    
    </div><div id="menu">
        <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" Width="100%" 
            BackColor="#3B7DB8" BorderColor="#3B7DB8" BorderStyle="Solid" BorderWidth="2px">
            <Items>
...
<a href="#"><img src="data1/images/01.jpg" alt="" title="" id="wows1"/></a>
...
<a href="#"><img src="data1/images/8.jpg" alt="" title="" id="wows4"/></a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=ALTERNATE><span class="log">SPDC VIRTUAL CLASSROOM</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
        style="color: #FFFFFF; text-align: center; vertical-align: middle;">Project By Vivek & Sahil </div>
    </form>
</body>
</html>
